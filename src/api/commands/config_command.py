...
def show_current_configurations(credentials: dict) -> None:
    """
    ...
    console.print("[dim]You can now use Workstate commands that require AWS access.[/dim]")
...
def show_config_error(error: Exception) -> None:
    """
